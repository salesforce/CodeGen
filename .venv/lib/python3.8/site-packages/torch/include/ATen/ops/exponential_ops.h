...
struct TORCH_API exponential_functional {
  ...
  STATIC_CONSTEXPR_STR_INL_EXCEPT_WIN_CUDA(schema_str, "exponential.functional(Tensor self, float lambd=1, *, Generator? generator=None) -> Tensor")
