...
TORCH_API ::std::vector<at::Tensor> _foreach_sub_functional(at::TensorList self, const at::Scalar & scalar);
...
TORCH_API ::std::vector<at::Tensor> _foreach_sub_functional(at::TensorList self, at::TensorList other, const at::Scalar & alpha=1);
...
TORCH_API ::std::vector<at::Tensor> _foreach_sub_functional(at::TensorList self, at::ArrayRef<at::Scalar> scalars);
