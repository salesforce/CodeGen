...
struct TORCH_API sparse_resize_functional {
  ...
  STATIC_CONSTEXPR_STR_INL_EXCEPT_WIN_CUDA(schema_str, "sparse_resize.functional(Tensor self, int[] size, int sparse_dim, int dense_dim) -> Tensor")
