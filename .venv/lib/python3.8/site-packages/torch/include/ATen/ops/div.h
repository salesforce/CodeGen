...
TORCH_API inline at::Tensor & div_out(at::Tensor & out, const at::Tensor & self, const at::Scalar & other) {
    return at::_ops::div_Scalar_out::call(self, other, out);
}

// aten::div.Scalar_out(Tensor self, Scalar other, *, Tensor(a!) out) -> Tensor(a!)
TORCH_API inline at::Tensor & div_outf(const at::Tensor & self, const at::Scalar & other, at::Tensor & out) {
    return at::_ops::div_Scalar_out::call(self, other, out);
}

// aten::div.Scalar_mode_out(Tensor self, Scalar other, *, str? rounding_mode, Tensor(a!) out) -> Tensor(a!)
TORCH_API inline at::Tensor & div_out(at::Tensor & out, const at::Tensor & self, const at::Scalar & other, c10::optional<c10::string_view> rounding_mode) {
    return at::_ops::div_Scalar_mode_out::call(self, other, rounding_mode, out);
}

// aten::div.Scalar_mode_out(Tensor self, Scalar other, *, str? rounding_mode, Tensor(a!) out) -> Tensor(a!)
TORCH_API inline at::Tensor & div_outf(const at::Tensor & self, const at::Scalar & other, c10::optional<c10::string_view> rounding_mode, at::Tensor & out) {
    return at::_ops::div_Scalar_mode_out::call(self, other, rounding_mode, out);
}
