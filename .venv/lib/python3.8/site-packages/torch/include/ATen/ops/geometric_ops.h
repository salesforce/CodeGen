...
struct TORCH_API geometric_functional {
  ...
  STATIC_CONSTEXPR_STR_INL_EXCEPT_WIN_CUDA(schema_str, "geometric.functional(Tensor self, float p, *, Generator? generator=None) -> Tensor")
