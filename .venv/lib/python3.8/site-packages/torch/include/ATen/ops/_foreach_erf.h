...
TORCH_API inline void _foreach_erf_out(at::TensorList out, at::TensorList self) {
    return at::_ops::_foreach_erf_out::call(self, out);
}

// aten::_foreach_erf.out(Tensor[] self, *, Tensor(a!)[] out) -> ()
TORCH_API inline void _foreach_erf_outf(at::TensorList self, at::TensorList out) {
    return at::_ops::_foreach_erf_out::call(self, out);
}

// aten::_foreach_erf.functional(Tensor[] self) -> Tensor[] self_out
TORCH_API inline ::std::vector<at::Tensor> _foreach_erf_functional(at::TensorList self) {
