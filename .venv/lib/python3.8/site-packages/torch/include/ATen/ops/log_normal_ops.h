...
struct TORCH_API log_normal_functional {
  ...
  STATIC_CONSTEXPR_STR_INL_EXCEPT_WIN_CUDA(schema_str, "log_normal.functional(Tensor self, float mean=1, float std=2, *, Generator? generator=None) -> Tensor")
